    ...
    <footer>
      <div className="content">
        <div className="left box">
          <div className="upper">
            ...
            <div className="cv__box">
              <a
                className="cv__btn"
                href="https://raw.githubusercontent.com/ashpakmulanii/portfolio/main/public/cv.pdf"
                download
              >
                Download CV
              </a>
          ...
          <div className="lower">
            ...
            <div id="Row">
              <div className="phone" style={{ paddingRight: "20px" }}>
                <a href="#">
                  <FaPhone /> <FaWhatsapp /> +91 7875735385
                </a>
              </div>
              <div className="email">
                <a href="#">
                  <FaMailBulk style={{ marginRight: "10px" }} />
                  ashpak.jsdev@gmail.com
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="middle box">
          ...
          <div>
            <a href="#">Diet plans and Calisthenics guidence</a>
          </div>
        </div>
